...
public class Slimefun extends JavaPlugin implements SlimefunAddon {
    ...
    public Slimefun() {
        ...
        // Covers both old (be.seeseemelk) and new (org.mockbukkit) package namespaces.
        String loaderPkg = getClassLoader().getClass().getPackageName();
        if (loaderPkg.startsWith("be.seeseemelk.mockbukkit") || loaderPkg.startsWith("org.mockbukkit.mockbukkit")) {
